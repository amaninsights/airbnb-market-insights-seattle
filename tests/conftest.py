...
def sample_listings():
    ...
    return pd.DataFrame({
        'id': [1, 2, 3, 4, 5],
        'name': ['Cozy Studio', 'Downtown Loft', 'Family Home', 'Beach House', 'Urban Apt'],
        'host_id': [101, 102, 103, 104, 105],
        'host_name': ['Alice', 'Bob', 'Charlie', 'Diana', 'Eve'],
        'neighbourhood': ['Capitol Hill', 'Downtown', 'Ballard', 'West Seattle', 'Capitol Hill'],
...
def sample_calendar():
    ...
    return pd.DataFrame({
        ...
        'date': list(dates),
        'available': [True, False, True, True, False, True, True, True, False, True],
